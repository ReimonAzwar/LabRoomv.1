...
function renderDayDetail(ds) {
    ...
    listEl.innerHTML = bookings.map(b => {
        ...
        return `
            <div class="rci">
                <div>
                    <div class="rcii"><strong>${escapeHTML(b.nama)}</strong> · ${escapeHTML(b.instansi)} <span class="tsm ${statusClass}">${statusText}</span></div>
                    <div class="rcit">📅 ${escapeHTML(b.jamMulai)}–${escapeHTML(b.jamSelesai)} | ${escapeHTML(b.keperluan)}</div>
                </div>
                <div class="rcia">
