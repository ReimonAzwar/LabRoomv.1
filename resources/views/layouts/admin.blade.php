...
<body>
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="{{ route('rooms.index') }}" class="nav-item {{ request()->routeIs('rooms.*') ? 'active' : '' }}">Manajemen Ruangan</a>
            <a href="{{ route('bookings.index') }}" class="nav-item {{ request()->routeIs('bookings.index') ? 'active' : '' }}">Tinjauan Reservasi</a>
            <a href="{{ route('bookings.create') }}" class="nav-item {{ request()->routeIs('bookings.create') ? 'active' : '' }}">Buat Reservasi (Admin)</a>
        </nav>
    </div>
