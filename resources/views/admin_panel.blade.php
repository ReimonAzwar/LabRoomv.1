...
<div class="ov" id="overlay">
  <div class="modal">
    ...
    <div class="mac"><button class="mb apc" id="m-approve">✓ Setujui</button><button class="mb rjc" id="m-reject">✕ Tolak</button><button class="mb cnc" onclick="closeModal()">Tutup</button></div>
  </div>
</div>
<!-- JS Parts -->
<script src="/js/admin_parts/utils.js"></script>
<script src="/js/admin_parts/auth.js"></script>
<script src="/js/admin_parts/ui_helpers.js"></script>
<script src="/js/admin_parts/navigation.js"></script>
<script src="/js/admin_parts/dashboard.js"></script>
<script src="/js/admin_parts/room_mgmt.js"></script>
<script src="/js/admin_parts/booking_actions.js"></script>
<script src="/js/admin_parts/modal_detail.js"></script>
